      ...
      <div className="max-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
       ...
       {/* destop navbar */}
        <div className="hidden items-center gap-6 md:flex">
          ...
          <Link to="/movies" className="transition hover:text-red-500">Movies </Link>
          <Link to="/about" className="transition hover:text-red-500">About</Link>
          <Link to="/movies" className="rounded-lg bg-red-600 px-5 py-2 font-medium transition hover:bg-red-700">Browse Movie</Link>
        </div>
